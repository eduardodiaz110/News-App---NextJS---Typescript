...
const CategoryNewsPage = ({newsArticles}: CategoryNewsPageProps) => {
    ...
    return ( 
        ...
        <main>
            <h1>{title}</h1>
            <Alert className="mb-5"> This page uses <strong>getStaticProps</strong> for very high page loading and <strong>incremental static regeneration</strong> to show data not older than <strong>5 minutes</strong>.</Alert>
